...
const INITIAL_PHOTOS = [
  {
    id: 'photo-6',
    url: '/assets/MP6.jpeg',
    caption: 'VINDHYAWASINI TILKUT BHANDAR • Heritage Craftsmanship',
    isCover: true,
    enabled: true,
    order: 0,
  },
  {
    id: 'photo-1',
    url: '/assets/Mp1.jpeg',
    caption: 'Traditional Wooden Mortar Preparation',
    isCover: false,
    enabled: true,
    order: 1,
  },
  {
    id: 'photo-2',
    url: '/assets/MP2.jpeg',
    caption: 'Golden Bihari Sweet Artwork',
    isCover: false,
    enabled: true,
    order: 2,
  },
  {
    id: 'photo-3',
    url: '/assets/MP3.jpeg',
    caption: 'Pure Desi Ghee Artisanal Sweets',
    isCover: false,
    enabled: true,
    order: 3,
  },
  {
    id: 'photo-4',
    url: '/assets/MP4.jpeg',
    caption: 'Authentic Gaya Gud Tilkut',
    isCover: false,
    enabled: true,
    order: 4,
  },
  {
    id: 'photo-5',
    url: '/assets/MP5.jpeg',
    caption: 'Royal Bihari Heritage Delicacies',
    isCover: false,
    enabled: true,
    order: 5,
  },
...
export const useJourneyGalleryStore = create(
  persist(
    ...
    {
      name: 'bindhyawasini_journey_photos_v2',
    }
  )
);
